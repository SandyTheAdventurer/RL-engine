...
float calc_max_mana(const PlayerStats& stats) {
    return 50.0f + stats.reasoning * 2.0f;
}

float calc_mana_regen(const PlayerStats& stats) {
    return 5.0f + stats.reasoning * 0.2f;
}
